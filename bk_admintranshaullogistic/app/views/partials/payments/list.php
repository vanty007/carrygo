            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <p class="page-subtitle">Review and manage all payment records on the platform.</p>
                        <div class="mt-4">
                            <div class="search-bar-container mx-auto" style="max-width: 500px;">
                                <input @keyup.enter="dosearch()" v-model="searchtext" class="form-control search-input" type="text" name="search" placeholder="Search by Tracking ID or Name..." />
                ...
                <div class="row justify-content-center" v-else>
                    <div class="col-sm-12 text-center py-5">
                        <div class="empty-state-card">
                            ...
                            <p class="text-muted">Payment history will appear here once transactions are made.</p>
                        </div>
                    </div>
                </div>
            </div>
