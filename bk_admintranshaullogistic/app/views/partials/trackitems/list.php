    ...
    <div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h1 class="page-title">Track All Deliveries</h1>
                        <p class="page-subtitle">Search and manage all deliveries on the platform from this admin dashboard.</p>
                        <div class="mt-4">
        ...
        <section class="section-sm" style="background-color: #f7f9fc;">
            <div class="container-fluid">
                ...
                <div class="widget">
                    <h4 class="widget-title">Delivery Orders</h4>
                    ...
                    <div v-for="(data,index) in records">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                <small class="text-muted">Pick Up User</small>
                                <p class="font-weight-bold mb-0"><i class="ti-user"></i> {{data.firstname}} {{data.lastname}}</p>
                                </div>
                                <div class="col-md-6 text-md-right">
                                <a :href="'tel:'+ data.phoneno" class="btn btn-sm btn-outline-success"><i class="ti-mobile"></i> Call User</a>
                                </div>
                            </div>
                        </div>
