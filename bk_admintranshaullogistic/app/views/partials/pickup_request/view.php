				...
				<div class="modal-content">
					...
					<div class="modal-body" style="display: grid;justify-content: center;align-items: center;">
						<div class="container">
							...
							<p>
								<textarea name="notes" cols="25" rows="3" v-model="reviewcomment" placeholder="Leave a comment..."></textarea>
								</br>
				...
				<div class="container">
					...
					<div class="card tracking-summary-card mb-4">
						...
						<?php if (ROLE_ID == "driver") { ?>
							<div class="card-footer text-center" v-if="data.pickup_status != 3">
						...
						<div class="col-lg-8">
							...
							<div class="card mb-4">
								...
								<div class="card-body">
									...
									<img class="img-fluid rounded" :src="data.picture || 'assets/images/carts.jpg'" alt="Item Picture" style="max-height: 250px;">
								</div>
							</div>
