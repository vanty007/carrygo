            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h1 class="page-title">Add New Delivery Option</h1>
                        <p class="page-subtitle">Define a new delivery service and set its pricing structure.</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <div class="card p-4 p-md-5">
                            <div v-if="!loading">
                                <form enctype="multipart/form-data" @submit.prevent="save" class="form form-default" method="post">
