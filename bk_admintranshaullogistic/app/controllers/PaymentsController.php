...
class PaymentsController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		$db = $this->GetModel();
		$fields = array('pickup_request.totalamount', 'pickup_request.created_at','user.firstname','user.lastname','user.email','user.phoneno','pickup_request.item_name','pickup_request.tracking_id','pickup_request.payment_status');
		...
		if(!empty($this->orderby)){
			...
			$db->orderBy('pickup_request.id', ORDER_TYPE);
		}
		if( !empty($fieldname) ){
