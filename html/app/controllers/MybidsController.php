...
class MybidsController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$sql = "SELECT c1.id,c1.name,c1.image,c1.url,c1.price,c1.open_points,c1.open_date,c1.status,c2.points FROM 
		carrygo_bid_entry c2, carrygo_bid c1 where c1.id=c2.bidid and c2.msisdn='$user' and c1.status = 0 ORDER BY c2.id DESC";
