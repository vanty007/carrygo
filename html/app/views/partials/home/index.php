							...
							<div class="fullwidth-filters ajax-search">
								...
								<div class="sort-by">
									...
									<!--<select @change="dosearch()" v-model="searchtext" name="searchtext" class="select2-sortby orderby select2-hidden-accessible"  data-select2-id="select2-data-1-bucr" tabindex="-1" aria-hidden="true">-->
										<select @change="dosearch2()" id="what_property" form="listeo_core-search-form" data-placeholder="Default order" class="select2-sortby orderby select2-hidden-accessible" data-select2-id="select2-data-1-bucr" tabindex="-1" aria-hidden="true">
						...
						<div class="listing-item-container list-layout">
							<div class="listing-item">
								...
								<div class="listing-item-content">
									<div class="listing-badge now-close"  v-if="data.bid_active_points === null">Bid Not Active</div>
									<div class="listing-badge now-open"  v-if="data.bid_active_points !== null">Bid Active</div>

									<div class="listing-item-inner">
										<h3>{{data.name}}<i class="verified-icon" v-if="data.bid_active_points !== null"></i><i class="verified-icon" style="color:red;" v-if="data.bid_active_points === null"></i></h3>
									...
									<span v-if="data.bid_winner_points === null" style="color:white;background-color:white;position: absolute;z-index: 101;right: 30px;bottom: 30px;cursor: normal;display: block;height: 44px;width: 44px;transition: all 0.4s;" >
