...
(function($){
    ...
    function mainMap() {
      //alert('dd')
      var propertyData = JSON.parse($('#getListDate').val());
      var temp_locations = [];
      ...
      for(var i=0; i<propertyData.length;i++){
        temp_locations.push([locationData('#/propertylist/view/'+propertyData[i]['id'],propertyData[i]['thumbnail'],propertyData[i]['name'],
        propertyData[i]['landmark'],propertyData[i]['avg_of_rate'],propertyData[i]['count_of_review']),propertyData[i]['latitude'],propertyData[i]['longitude'],i+1,'<i class="im im-icon-Home-2"></i>',propertyData[i]['id']]);
  
        }
        console.log(temp_locations);

      var locations = temp_locations;/*[
      ...
      var mapZoomAttr = $('#mapp').attr('data-map-zoom');
      var mapScrollAttr = $('#mapp').attr('data-map-scroll');
      ...
      var mapp = new google.maps.Map(document.getElementById('mapp'), {
        ...
        center: new google.maps.LatLng(temp_locations[0][1], temp_locations[0][2]),
      ...
      // Custom Zoom-In and Zoom-Out Buttons
        ...
        var zoomControl = new ZoomControl(zoomControlDiv, mapp);
      ...
      $(scrollEnabling).click(function(e){
          ...
          if ( $(this).is(".enabled") ) {
             mapp.setOptions({'scrollwheel': true});
          } else {
             mapp.setOptions({'scrollwheel': false});
          }
      })
    ...
    if (typeof(mapp) != 'undefined' && mapp != null) {
      google.maps.event.addDomListener(window, 'load',  mainMap);
    }

    $(document).ready(function() {
      $().ready(function() {
		$("#btndosearchMap").click(function(){
      //alert(' map')
			setTimeout(function() {
				if (typeof(mapp) != 'undefined' && mapp != null) {
          //alert('map2')
