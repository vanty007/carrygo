   ...
   <div class="container">
	   ...
	   <div class="left-side">
		   ...
		   <ul id="responsive" >
						...
						<li onclick="ftrendingitems()" class="current"><a style="cursor: pointer;">Trending Items</a></li>
...
<div class="fs-container">
	<h2 style="text-align: center;">Trending Bids</h2>
						...
						<div class="listing-item-container list-layout">
							<div class="listing-item">
								...
								<div class="listing-item-content">
									...
									<span style="color:white;background-color:white;position: absolute;z-index: 101;right: 30px;bottom: 30px;cursor: normal;display: block;height: 44px;width: 44px;transition: all 0.4s;" >
...
<!-- Wrapper / End -->
        ...
        <script>
			var TrendingListComponent = Vue.component('bidList', {
				template : '#trendingList',
