								...
								<div id="listeo-listings-container" class=" compact-layout row" v-if="records.length">
									...
									<div class="col-lg-6 col-md-6 col-xs-6 col-sm-6" v-for="(data,index) in records">
											<div v-if="data.bid_entry_points !== null"  class="listing-item-container listing-geo-data compact" :data-image="data.image">
												...
												<div class="listing-small-badge" style="padding-left: 8px;background-color:transparent;border-radius:0px;font-size:16px;"><router-link style="text-decoration:none;" :to="'/leaderboardbid/index/name/' +  data.id">{{data.name}}</router-link> 
													
												</div>
												</br></br></br>
												<div class="listing-small-badge pricing-badge"><i class="fa fa-money"></i>&#8358;{{data.price}}</div>
												<div class="listing-small-badge pricing-badge"><i class="fa fa-tag"></i><strong>{{maskedPhoneNumber(data.msisdn)}} Currently Leading</strong></div>
												</br></br>
