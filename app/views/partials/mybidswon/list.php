...
<div class="fs-container">
	...
	<div class="container content">
		...
		<section class="listings-container margin-top-30">
				<h2 style="text-align: center;">My Bids Won</h2>
											...
											<div v-if="data.bid_entry_points !== null"  class="listing-item-container listing-geo-data compact" :data-image="data.image">
												<div class="listing-item  featured-listing" @click="showpop(data.image)">
													<div class="listing-small-badges-container" style="float:left;width:250px">
														<div class="listing-small-badge featured-badge" v-if="data.bid_active_points !== null"><i class="fa fa-tag" style="color:white;background-color:green;"></i>{{data.total_points}} Bidded Points</div>
													</div>
...
<!-- Wrapper / End -->
        ...
        <script>
			var MybidswonListComponent = Vue.component('mybidswonList', {
				template : '#mybidswonList',
