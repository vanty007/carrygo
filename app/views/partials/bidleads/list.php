			...
			<div class="right-side">
				<div class="header-widget">
					...
					<div class="user-menu">
						...
						<ul v-if="user.points == 0">
							<li><a style="cursor: pointer;" ><i class="sl sl-icon-wallet"></i> Get Points / Login</a></li>
						</ul>
					</div>
				</div>
			</div>
...
<!-- Wrapper / End -->
        ...
        <script>
			var bidleadsListComponent = Vue.component('bidleadsList', {
				template : '#bidleadsList',
