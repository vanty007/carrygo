 ...
 * @category  Controller
 */
class MybidsController extends SecureController{
	/**
     * Index Action
     * @return View
     */
	function index($fieldname = null , $fieldvalue = null){
		...
		$sql = "SELECT c1.id,c1.name,c1.rating,c1.image,c1.url,c1.price,c1.open_points,c1.open_date,c1.status,SUM(c2.points) points,SUM(c3.points) bid_active_points,
		...
		/*$sql = "SELECT c1.id,c1.name,c1.image,c1.url,c1.price,c1.open_points,c1.open_date,c1.status,sum(c2.points) points FROM 
		carrygo_bid_entry c2, carrygo_bid c1 where c1.id=c2.bidid and c2.msisdn='$user' and c1.status = 0 GROUP BY c1.id ORDER BY c1.id DESC";*/
