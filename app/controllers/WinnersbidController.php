...
class WinnersbidController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$sql = "SELECT c1.id,c1.name,c1.rating,c1.image,c1.url,c1.price,c1.open_points,c1.open_date,c1.status,SUM(c2.points) bid_entry_points, 
		c4.total_points as bid_winner_points,c4.msisdn
		...
		where c1.status = 2 GROUP BY c4.total_points,c4.msisdn,c1.id ORDER BY c1.id DESC";	
