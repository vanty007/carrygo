...
class SecureController extends BaseController{
	function __construct(){
		...
		$exclude_pages = array('propertysearch/list', 'auth/userregister', 'auth/add', 'chargetype/list', 'chargetype/view', 'chargetype/add', 'chargetype/edit', 'chargetype/delete', 'facilitytype/list', 'facilitytype/view', 'facilitytype/add', 'facilitytype/edit', 'facilitytype/delete', 'propertyfacility/list', 'propertyfacility/view', 'propertyfacility/add', 'propertyfacility/edit', 'propertyfacility/delete', 'propertylist/list', 'propertylist/view', 'propertylist/add', 'propertylist/edit', 'propertylist/delete', 'propertylocations/list', 'propertylocations/view', 'propertylocations/add', 'propertylocations/edit', 'propertylocations/delete', 'propertytype/list', 'propertytype/view', 'propertytype/add', 'propertytype/edit', 'propertytype/delete', 'rating/list', 'rating/view', 'rating/add', 'rating/edit');
