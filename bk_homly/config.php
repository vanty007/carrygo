<?php
	...
	define('DB_USERNAME','televets');
	define('DB_PASSWORD','Televet20254%');
	define('DB_NAME','homly');
	...
	define('MAX_RECORD_COUNT', 5); //Default Max Records to Retrieve  per Page
	...
	define('USER_NAME',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['email'] : null ));
	define('USER_EMAIL',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['email'] : null ));
	define('ROLE_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['role_id'] : null ));
	define('FIRST_NAME',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['firstname'] : null ));
	define('LAST_NAME',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['lastname'] : null ));
	define('USER_PHOTO',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['profile_pics'] : null ));
