<template id="propertyavailabilityAdd">
<div>
<div id="wrapper">
...
<div id="dashboard">
	...
	<div class="dashboard-content">
	 <!-- <div class="map-container">
		...
		<div class="row">
			<div class="col-lg-12" v-if="owner_status==0">
				<h2>You cannot upload items now until your application is approved</h2> 
			</div>
			<div class="col-lg-12" v-if="owner_status==1">
                <form enctype="multipart/form-data" @submit="save" class="form form-default" action="propertyavailability/add" method="post">
				<div id="add-listing">
...
<div class="submit-section">
    ...
    <div class="row with-forms">
		...
		<!--<div class="col-md-6">
			...
			<input class="search-field" v-model="data.address" data-vv-as="Property Address" type="text" name="address"/>
					...
					<div class="add-listing-section">
                        ...
                        <div class="row with-forms">
							<div class="col-md-6">
								...
								<input class="search-field" v-model="data.contactemail"  data-vv-as="Property Contactemail" 
							...
							<div class="col-md-6">
								...
								<input class="search-field" v-model="data.contactphone" data-vv-as="Property Contactphone" 
					...
					<div id="add-comment" class="add-comment">
						<fieldset>
								...
								<h5>Facilities (separated with ,) <i class="tip" data-tip-content="facilities"></i></h5>
									...
									<!--<datacheck v-model="data.facilities" data-vv-value-path="data.facilities" data-vv-as="facilities" v-validate="{required:true}" type="checkbox"
                                        name="facilities" :datasource="facilitiesOptionList"></datacheck>
				...
				<div class="submit-section">
					...
					<div class="row with-forms">
						<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-9">
									<input class="search-field date-picker2" type="text" @click="getGeolocation()"/>
									<input id="idinvalidfrom" v-model="data.invalidfrom"  data-vv-as="Property Available From" type="hidden" name="idinvalidfrom"/>
									<input id="idinvalidto" v-model="data.invalidto"  data-vv-as="Property Available To" type="hidden" name="idinvalidto"/>
								</div>
								<div class="col-md-3">
						...
						<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-9">
									<textarea readonly id="idAvailability" name="idAvailability" cols="40" rows="3" class="search-field"type="text"></textarea>
								</div>
								<div class="col-md-3">
								<!--<button class="button preview" type="submit">Add<i class="fa fa-send"></i></button>-->
...
<!-- Wrapper / End -->
    ...
    <script>
			var latitude = '0';
			var longitude = '0';
	var PropertyavailabilityAddComponent = Vue.component('propertyavailabilityAdd', {
		template : '#propertyavailabilityAdd',
		mixins: [AddPageMixin],
		props:{
			pagename : {
				type : String,
			...
			routename : {
				type : String,
				default : 'propertyavailabilityadd',
			},
			apipath : {
				type : String,
				default : 'propertyavailability/add',
			},
		},
		data : function() {
			return {
				...
				data : {
					//name:'',address:'',landmark:'',contactphone:'',contactemail:'',contactname:'',property_id: '',type: '',quantity: '',price: '',rooms: '',description: '',pictures: '',thumbnail: '',status: '',invalidfrom: '',invalidto: '',
                    service_charge:0,longitude:'',latitude:'',facilities:'',invalidto:'',invalidfrom:'',city:'',state:'',country:'',name:'',address:'',landmark:'',contactphone:'',contactemail:'',contactname:'',property_id: '',type: '',quantity: '',price: '',rooms: 'Day',description: '',pictures: '',thumbnail: ''
				},
				owner_status: '',
				...
				facilitiesOptionList: [{"label":"All Day Power Supply","value":"All Day Power Supply"},{"label":"All Day Security","value":"All Day Security"}
				,{"label":"Free High-Speed Internet","value":"Free High-Speed Internet"},{"label":"Premium Sound Bar","value":"Premium Sound Bar"}
				,{"label":"Smart lock-Code","value":"Smart lock-Code"},{"label":"Air Conditioning","value":"Air Conditioning"},{"label":"DSTV Netflix & YouTube","value":"DSTV Netflix & YouTube"}
				,{"label":"Fully Fitted Kitchen","value":"Fully Fitted Kitchen"},{"label":"Chef on Request","value":"Chef on Request"}
				,{"label":"Housekeeping Services","value":"Housekeeping Services"},{"label":"Spa On Request","value":"Spa On Request"}
				,{"label":"Property Manager","value":"Property Manager"},{"label":"All Rooms En-Suite","value":"All Rooms En-Suite"}
				,{"label":"Ample Parking Space","value":"Ample Parking Space"}],
			}
		},
		computed: {
			pageTitle: function(){
				return 'Add New Propertyavailability';
			},
		},
		methods: {
			get_owner_info : function(){
				var apiurl = setApiUrl('components/get_owner_info');
				this.$http.get( apiurl).then(function (response) {
					var data = response.body;
					console.log(data['status'])
					this.owner_status = data['status'];
					},
				function (response) {
			...
			var address = this.data.landmark;
      ...
      //console.log(e.srcElement.defaultValue)
			...
			resetForm : function(){
//				this.data = {name:'',address:'',landmark:'',contactphone:'',contactemail:'',contactname:'',property_id: '',type: '',quantity: '',price: '',rooms: '',description: '',pictures: '',thumbnail: '',status: '',invalidfrom: '',invalidto: '',};
			this.data = {service_charge:0,longitude:'',latitude:'',facilities:'',invalidto:'',invalidfrom:'',city:'',state:'',country:'',name:'',address:'',landmark:'',contactphone:'',contactemail:'',contactname:'',property_id: '',type: '',quantity: '',price: '',rooms: 'Day',description: '',pictures: '',thumbnail: ''};
