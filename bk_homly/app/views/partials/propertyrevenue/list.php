<template id="propertyrevenueList">
	<div>
		<div id="wrapper">
...
<!-- Header Container / End -->
					...
					<div class="col-12">
						<div class="card my-4">
							...
							<div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
								<h6 class="text-white text-capitalize ps-3" style="font-size:13px;">Property Revenue</h6>
							</div>
							</div>
							<div class="card-body px-0 pb-2">
								<div class="table-responsive p-0" v-if="records.length" ref="datatable">
									...
									<tbody>
                                        ...
                                        <tr>
                                          <td colspan="4" class="grand-total-label" style="font-weight: bold;">Total:</td>
    ...
    <script>
	var PropertyrevenueListComponent = Vue.component('propertyrevenueList', {
		template: '#propertyrevenueList',
		...
		props: {
			...
			pagename : {
				type : String,
				default : 'property revenue',
			},
			routename : {
				type : String,
				default : 'propertyrevenue',
			},
			apipath : {
				type : String,
				default : 'propertyrevenue/list',
			},
			exportbutton: {
				type: Boolean,
				default: false,
        ...
        return sum.toLocaleString();
         ...
         grandTotal_Amount() {
            let sum = 0;
            this.records.forEach(item => sum += parseInt(item.amount));
        return sum.toLocaleString();
        },
			pageTitle: function(){
					...
					this.$http.get(url).then(function (response) {
						...
						if(data && data.records){
							...
							for(var i=0;i<data.records.length;i++){
								...
								arr_value.push(data.records[i]['amount']);
							}
