    <template id="propertygalleryList">
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container-fluid">
                    <div class="row ">
                        <div  class="col-sm-4 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Propertygallery</h3>
                        </div>
                        <div  class="col-sm-3 comp-grid" :class="setGridSize">
                            <router-link v-if="addbutton" class="btn btn btn-primary btn-block" :to="'/propertygallery/add'">
                            <i class="fa fa-plus"></i>
                            Add New Propertygallery
                            </router-link>
                        </div>
                            ...
                            <div  class=" animated fadeIn">
                                <div class="">
                                    <nav v-if="fieldname || filterMsgs.length" class="page-header-breadcrumbs mb-3" aria-label="breadcrumb">
                                        <ul class="breadcrumb m-0 p-2">
                                            <li v-if="fieldname" class="breadcrumb-item">
                                                <router-link class="text-capitalize" to="/propertygallery">Propertygallery</router-link>
                                            </li>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4" v-for="(data,index) in records" >
                                                <div class="card p-2 mb-4">
                                                    ...
                                                    <div >
                                                        <router-link v-if="viewbutton" class="btn btn-sm btn-outline-primary" title="View Record" :to="'/propertygallery/view/' + data.id">
                                                        <i class="fa fa-eye"></i> 
                                                        </router-link>
                                                        <router-link v-if="editbutton" class="btn btn-sm btn-outline-success" title="Edit This Record" :to="'/propertygallery/edit/' + data.id">
                                    ...
                                    <div v-if="showfooter" class="page-footer">
                                        ...
                                        <dataimport extensions="" buttontext="" post-action="propertygallery/import_data" v-if="importbutton"></dataimport>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
	var PropertygalleryListComponent = Vue.component('propertygalleryList', {
		template: '#propertygalleryList',
		...
		props: {
			...
			routename : {
				type : String,
				default : 'propertygallerylist',
			},
			apipath : {
				type : String,
				default : 'propertygallery/list',
			},
			tablestyle: {
				type: String,
