                                    ...
                                    <div ref="datatable" id="datatable">
                                        <table class="table table-hover table-borderless table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th class="title"> Propertyavai Id :</th>
                                                    <td class="value"> {{ data.propertyavai_id }} </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="value"><router-link :to="'/payments/view/' +  data.id">{{data.upload}}</router-link></td>
                                                </tr>
                                                <tr>
	...
	var PaymentsViewComponent = Vue.component('paymentsView', {
		...
		data: function() {
			return {
				data : {
					default :{
						id: '',propertyavai_id: '',user_id: '',type: '',status: '',upload: '',amount: '',created_at: '',
					},
				},
			}
		},
