...
class ProductsController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		$db = $this->GetModel();
		$fields = array('id', 	'name', 	'price', 	'period', 	'description', 	'productid', 	'serviceid', 	'spid', 	'auth', 	'created_at');
		...
		if(!empty($this->search)){
			...
			$db->orWhere('period',"%$text%",'LIKE');
			$db->orWhere('description',"%$text%",'LIKE');
			$db->orWhere('productid',"%$text%",'LIKE');
			$db->orWhere('serviceid',"%$text%",'LIKE');
			$db->orWhere('spid',"%$text%",'LIKE');
			$db->orWhere('auth',"%$text%",'LIKE');
	...
	function edit($rec_id=null){
		...
		if(is_post_request()){
			...
			$fields=array('id','name','price','period','description','productid','serviceid','spid','auth');
			$db->where('id' , $rec_id);
