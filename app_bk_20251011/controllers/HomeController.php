...
class HomeController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$sql_winner = "SELECT c1.id,c1.name,c1.image,c1.url,c1.price,c1.open_points,c1.open_date,c1.status, c4.total_points as bid_winner_points,c4.msisdn,c4.id w_id 
		FROM carrygo_bid as c1 
	...
	private function postbid($msisdn , $points,$bidid,$open_points,$open_date){
		...
		if(!empty($user)){
			...
			$active_bid_timer = (round(abs($today-$dayinpass)/60/60));
