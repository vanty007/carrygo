<template id="user_creditList">
					...
					<div class="col-12">
						<div class="card my-4">
							...
							<div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
								<h6 class="text-white text-capitalize ps-3">Daily Winners</h6>
							</div>
							</div>
							<div class="card-body px-0 pb-2">
								<div class="table-responsive p-0" v-if="records.length" ref="datatable">
									...
									<thead>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Airtime</Data></th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Transaction ID</Data></th>
    ...
    <script>
	var User_CreditListComponent = Vue.component('user_creditList', {
		template: '#user_creditList',
		...
		props: {
			...
			routename : {
				type : String,
				default : 'user_creditlist',
			},
			apipath : {
				type : String,
				default : 'user_credit/list',
			},
			tablestyle: {
				type: String,
