						...
						Sorting / Layout Switcher 
							...
							<div class="row fs-listings"  v-if="records.length">
								<div class="col-lg-12 col-md-12" v-for="(data,index) in records">
									<div v-if="data.bid_entry_points !== null" class="listing-item-container listing-geo-data list-layout listing-type-service"  data-listing-type="service" data-campaign-placement="home">
