<template id="carrygo_points_dailybreakdownList">
                     ...
                     <div class="col-md-12">
                        ...
                        <nav id="breadcrumbs">
                           <ul>
                              ...
                              <li>Carry Go Points Breakdown</li>
                           </ul>
                        </nav>
                     </div>
                  </div>
					...
					<div class="col-12">
						<div class="card my-4">
							...
							<div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
								<h6 class="text-white text-capitalize ps-3">Carry Go Points Breakdown</h6>
							</div>
							</div>
								...
								<div class="table-responsive p-0" v-if="records.length" ref="datatable">
									...
									<thead>
										<tr>
                                            ...
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"> Total Bidded Points</th>
    ...
    <script>
	var Carrygo_points_dailybreakdownComponent = Vue.component('carrygo_points_dailybreakdownList', {
		template: '#carrygo_points_dailybreakdownList',
