<template id="carrygo_bid_activeList">
    <div>
      <div id="wrapper">
         <!-- Header Container
            ================================================== -->
			   ...
			   <div class="row">
					<div class="col-12">
						<div class="card my-4">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <h6 class="text-white text-capitalize ps-3">Open Bids</h6>
                                </div>
								...
								<div class="table-responsive p-0" v-if="records.length" ref="datatable">
									...
									<thead>
										<tr>
                                            ...
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"> Accumulated Points</th>
    ...
    <script>
	var Carrygo_Bid_ActiveListComponent = Vue.component('carrygo_bid_activeList', {
		template: '#carrygo_bid_activeList',
		...
		props: {
			...
			routename : {
				type : String,
				default : 'carrygo_bid_activelist',
			},
			apipath : {
				type : String,
				default : 'carrygo_bid_active/list',
			},
			tablestyle: {
				type: String,
