    <template id="carrygo_session_logEdit">
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Edit  Carrygo Session Log</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form  v-show="!loading" enctype="multipart/form-data" @submit="update()" class="form form-default" :action="'carrygo_session_log/edit/' + data.id" method="post">
    ...
    <script>
	var Carrygo_Session_LogEditComponent = Vue.component('carrygo_session_logEdit', {
		template : '#carrygo_session_logEdit',
		...
		props: {
			...
			routename : {
				type : String,
				default : 'carrygo_session_logedit',
			},
			apipath : {
				type : String,
				default : 'carrygo_session_log/edit',
			},
		},
		data: function() {
			return {
				data : { session_id: '',msisdn: '',pcode: '',session_date: '',status: '',session_duration_millis: '',subid: '',amount: '',expirydate: '',doiflag: '',channel: '', },
			}
		},
		computed: {
			pageTitle: function(){
				return 'Edit  Carrygo Session Log';
			},
		},
		methods: {
