    <template id="session_logEdit">
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Edit  Session Log</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form  v-show="!loading" enctype="multipart/form-data" @submit="update()" class="form form-default" :action="'session_log/edit/' + data.id" method="post">
    ...
    <script>
	var Session_LogEditComponent = Vue.component('session_logEdit', {
		template : '#session_logEdit',
		...
		props: {
			...
			routename : {
				type : String,
				default : 'session_logedit',
			},
			apipath : {
				type : String,
				default : 'session_log/edit',
			},
		},
		data: function() {
			return {
				data : { session_id: '',msisdn: '',last_command: '',session_date: '',status: '',session_duration_millis: '',message: '',last_session_date: '',network: '',doiflag: '',channel: '', },
			}
		},
		computed: {
			pageTitle: function(){
