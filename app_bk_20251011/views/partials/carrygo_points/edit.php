    <template id="carrygo_pointsEdit">
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Edit  Carrygo Points</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form  v-show="!loading" enctype="multipart/form-data" @submit="update()" class="form form-default" :action="'carrygo_points/edit/' + data.id" method="post">
    ...
    <script>
	var Carrygo_PointsEditComponent = Vue.component('carrygo_pointsEdit', {
		template : '#carrygo_pointsEdit',
		...
		props: {
			...
			routename : {
				type : String,
				default : 'carrygo_pointsedit',
			},
			apipath : {
				type : String,
				default : 'carrygo_points/edit',
			},
		},
		data: function() {
			return {
				data : { msisdn: '',description: '',points: '',status: '', },
			}
		},
		computed: {
			pageTitle: function(){
				return 'Edit  Carrygo Points';
			},
		},
		methods: {
