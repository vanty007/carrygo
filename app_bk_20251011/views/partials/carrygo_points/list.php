<template id="carrygo_pointsList">
...
<div>
			   ...
			   <div class="row">
					<div class="col-12">
						<div class="card my-4">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <h6 class="text-white text-capitalize ps-3">User's Points</h6>
                                </div>
    ...
    <script>
	var Carrygo_PointsListComponent = Vue.component('carrygo_pointsList', {
		template: '#carrygo_pointsList',
		...
		props: {
			...
			routename : {
				type : String,
				default : 'carrygo_pointslist',
			},
			apipath : {
				type : String,
				default : 'carrygo_points/list',
			},
			tablestyle: {
				type: String,
