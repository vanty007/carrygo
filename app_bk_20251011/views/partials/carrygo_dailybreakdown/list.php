<template id="carrygo_dailybreakdownList">
                     ...
                     <div class="col-md-12">
                        ...
                        <nav id="breadcrumbs">
                           <ul>
                              ...
                              <li>Carry Go Subscriptions Breakdown</li>
                           </ul>
                        </nav>
                     </div>
                  </div>
					...
					<div class="col-12">
						<div class="card my-4">
							...
							<div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
								<h6 class="text-white text-capitalize ps-3">Carry Go Subscriptions Breakdown</h6>
							</div>
							</div>
    ...
    <script>
	var Carrygo_dailybreakdownComponent = Vue.component('carrygo_dailybreakdownList', {
		template: '#carrygo_dailybreakdownList',
