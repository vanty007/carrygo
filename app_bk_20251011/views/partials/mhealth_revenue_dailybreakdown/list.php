<template id="mhealth_revenue_dailybreakdownList">
                     ...
                     <div class="col-md-12">
                        ...
                        <nav id="breadcrumbs">
                           <ul>
                              ...
                              <li>Mhealth Revenue Breakdown</li>
                           </ul>
                        </nav>
                     </div>
                  </div>
					...
					<div class="col-12">
						<div class="card my-4">
							...
							<div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
								<h6 class="text-white text-capitalize ps-3">Mhealth Revenue Breakdown</h6>
							</div>
							</div>
    ...
    <script>
	var Mhealth_Revenue_dailybreakdownComponent = Vue.component('mhealth_revenue_dailybreakdownList', {
		template: '#mhealth_revenue_dailybreakdownList',
