                        ...
                        <div class="container-fluid">
                            <div class="row ">
                                <div  class="col-sm-3 comp-grid" :class="setGridSize">
                                    <button class="btn btn btn-primary btn-block" onclick="fcarrygo_bid_add()">
					...
					<div class="col-12">
						<div class="card my-4">
							...
							<div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
								<h6 class="text-white text-capitalize ps-3">Bid Items</h6>
							</div>
							</div>
								...
								<div class="table-responsive p-0" v-if="records.length" ref="datatable">
									...
									<thead>
										<tr>
                                            ...
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"> Open Points</th>
									...
									<tbody>
										<tr v-for="(data,index) in records">
                                                    ...
                                                    <td>
                                                        <span v-if="data.status == '0'">Enabled</span>
                                                        <span v-else-if="data.status == '1'">Disabled</span>
											        </td>
                                                    <th class="td-btn">
                                                        <div >
