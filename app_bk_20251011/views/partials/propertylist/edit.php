    <template id="propertylistEdit">
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Edit  Propertylist</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form  v-show="!loading" enctype="multipart/form-data" @submit="update()" class="form form-default" :action="'propertylist/edit/' + data.id" method="post">
    ...
    <script>
	var PropertylistEditComponent = Vue.component('propertylistEdit', {
		template : '#propertylistEdit',
		...
		props: {
			...
			routename : {
				type : String,
				default : 'propertylistedit',
			},
			apipath : {
				type : String,
				default : 'propertylist/edit',
			},
		},
		data: function() {
			return {
				data : { propertytype_id: '',name: '',chargetype_id: '',rating_id: '',address: '',location_id: '',landmark: '',longitude: '',latitude: '',status: '',user_id: '',contactphone: '',contactemail: '',contactname: '',checkin: '',checkout: '',cancellation: '',pets: '',views: '', },
			}
		},
		computed: {
			pageTitle: function(){
