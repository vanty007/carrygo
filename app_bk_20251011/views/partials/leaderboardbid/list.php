        <template id="leaderboardbidList">
		<div>
...
<div class="fs-container">
	...
	<div class="container content">
		...
		<section class="listings-container margin-top-30">
			<h2 style="text-align: center;">Top 5 Leaders for Bid</h2>
									...
									<div class="listing-item ">
										...
										<div class="listing-item-content">
											...
											<div class="listing-item-inner">
												...
												<span>{{data.bid_entry_points}} Points Bidded <strong> by {{maskedPhoneNumber(data.msisdn)}}</strong></span>
...
<!-- Wrapper / End -->
        ...
        <script>
			var LeaderboardbidListComponent = Vue.component('leaderboardbidList', {
				template : '#leaderboardbidList',
