<template id="carrygo_subscriptionsList">
    <div>
      <div id="wrapper">
         <!-- Header Container
            ================================================== -->
					...
					<div class="col-12">
						<div class="card my-4">
							...
							<div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                                <div class="row">
                                    <div class="col-4">
                                        <h6 class="text-white text-capitalize ps-3">Carrygo Subscription</h6>
                                    </div>
							...
							<div class="card-body px-0 pb-2">
								<div class="table-responsive p-0" v-if="records.length" ref="datatable">
									...
									<thead>
										<tr>
										<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Subscription Date</Data></th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Expiry Date</Data></th>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Msisdn</th>
    ...
    <script>
	var Carrygo_SubscriptionsListComponent = Vue.component('carrygo_subscriptionsList', {
		template: '#carrygo_subscriptionsList',
		...
		props: {
			...
			routename : {
				type : String,
				default : 'carrygo_subscriptionslist',
			},
			apipath : {
				type : String,
				default : 'carrygo_subscriptions/list',
			},
			tablestyle: {
				type: String,
