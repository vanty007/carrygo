    <template id="carrygo_subscriptionsView">
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">View  Carrygo Subscriptions</h3>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div  class=" animated fadeIn">
                                <div v-show="!loading">
                                    ...
                                    <div v-if="editbutton || deletebutton || exportbutton" class="py-3">
                                        <span >
                                            <router-link class="btn btn-sm btn-info has-tooltip" v-if="editbutton"  :to="'/carrygo_subscriptions/edit/'  + data.tid">
                                            <i class="fa fa-edit"></i> 
                                            </router-link>
                                            <button @click="deleteRecord" class="btn btn-sm btn-danger" v-if="deletebutton" :to="'/carrygo_subscriptions/delete/' + data.tid">
    ...
    <script>
	var Carrygo_SubscriptionsViewComponent = Vue.component('carrygo_subscriptionsView', {
		template : '#carrygo_subscriptionsView',
		...
		props: {
			...
			routename : {
				type : String,
				default : 'carrygo_subscriptionsview',
			},
			apipath: {
				type : String,
				default : 'carrygo_subscriptions/view',
			},
		},
		data: function() {
			return {
		...
		computed: {
			pageTitle: function(){
				return 'View  Carrygo Subscriptions';
			},
		},
		methods :{
			resetData : function(){
