    <template id="carrygo_subscriptionsEdit">
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Edit  Carrygo Subscriptions</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form  v-show="!loading" enctype="multipart/form-data" @submit="update()" class="form form-default" :action="'carrygo_subscriptions/edit/' + data.id" method="post">
    ...
    <script>
	var Carrygo_SubscriptionsEditComponent = Vue.component('carrygo_subscriptionsEdit', {
		template : '#carrygo_subscriptionsEdit',
		...
		props: {
			...
			routename : {
				type : String,
				default : 'carrygo_subscriptionsedit',
			},
			apipath : {
				type : String,
				default : 'carrygo_subscriptions/edit',
			},
		},
		data: function() {
			return {
		...
		computed: {
			pageTitle: function(){
				return 'Edit  Carrygo Subscriptions';
			},
		},
		methods: {
