								...
								<div class="col-lg-12 col-md-12" v-for="(data,index) in records">
									...
									<div class="listing-item ">
										...
										<div class="listing-item-content">
											<div class="listing-badge now-closed" style="color:white;background-color:green;">Bid Open</div>
											<div class="listing-item-inner">
												...
												<div class="listing-list-small-badges-container">
													...
													<div class="listing-small-badge pricing-badge"><i class="fa fa-tag"></i>Time Left: {{getTimeleft(data.created_at,data.open_date-1)}}</div>
												</div>
												<span>({{data.bid_active_points}} Bidded Points)</span>
...
<!-- Wrapper / End -->
	   ...
	   formatCustom(date) {
		...
		return `${open_date-hours} hour(s), ${60-minutes} minute(s)`;
       },
