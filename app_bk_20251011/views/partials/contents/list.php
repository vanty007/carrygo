<template id="contentsList">
					...
					<div class="col-12">
						<div class="card my-4">
							...
							<div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
								<h6 class="text-white text-capitalize ps-3">M-Health Contents</h6>
							</div>
							</div>
							<div class="card-body px-0 pb-2">
								<div class="table-responsive p-0" v-if="records.length" ref="datatable">
									...
									<thead>
										<tr>
										<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Date</Data></th>
										<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Content Category</th>
									...
									<tbody>
										<tr v-for="(data,index) in records">
											...
											<td>
												<span v-if="data.category_id == '1'">Dogs</span>
												<span v-else-if="data.category_id == '2'">Cats</span>
												<span v-else-if="data.category_id == '3'">Fish</span>
												<span v-else-if="data.category_id == '4'">Bird</span>
												<span v-else-if="data.category_id == '5'">Cattle</span>
												<span v-else-if="data.category_id == '6'">Domestic Animals</span>
											</td>
											<td><img :src="data.picture"  alt="user1"/> </td>
											<td><div style="font-size: 20px;text-wrap: balance;">{{ data.contents }}</div></td>
    ...
    <script>
	var ContentsListComponent = Vue.component('contentsList', {
