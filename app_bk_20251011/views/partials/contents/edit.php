    <template id="contentsEdit">
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Edit  Contents</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form  v-show="!loading" enctype="multipart/form-data" @submit="update()" class="form form-default" :action="'contents/edit/' + data.id" method="post">
    ...
    <script>
	var ContentsEditComponent = Vue.component('contentsEdit', {
		template : '#contentsEdit',
		...
		data: function() {
			return {
				data : { vet_id: '',user_id: '',subject: '',contents: '',category_id: '',picture: '',status: '',created_at: '', },
			}
		},
		computed: {
			pageTitle: function(){
