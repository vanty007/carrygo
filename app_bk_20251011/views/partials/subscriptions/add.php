    <template id="subscriptionsAdd">
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Add New Subscriptions</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form enctype="multipart/form-data" @submit="save" class="form form-default" action="subscriptions/add" method="post">
    ...
    <script>
	var SubscriptionsAddComponent = Vue.component('subscriptionsAdd', {
		template : '#subscriptionsAdd',
		mixins: [AddPageMixin],
		props:{
			pagename : {
				type : String,
			...
			routename : {
				type : String,
				default : 'subscriptionsadd',
			},
			apipath : {
				type : String,
				default : 'subscriptions/add',
			},
		},
		data : function() {
			return {
