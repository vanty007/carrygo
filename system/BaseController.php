...
class SecureController extends BaseController{
	function __construct(){
		...
		$exclude_pages = array('leaderboardbid/list','leaderboard/list', 'winnersbid/list', 'bid/view','home/list', 'home/index', 'bid/list', 'property/search','trending/list','mybidswon/list','mybids/list','openbid/list','bidleads/list','home/postbid_info');
